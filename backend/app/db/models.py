from sqlalchemy import Boolean, Column, ForeignKey, Integer, String, Float, DateTime, JSON, ARRAY
...
class Player(Base):
    ...
    role = Column(String, index=True)  # GK, DEF, MID, FWD
    price = Column(Float)
    stats = Column(JSON)  # FBref data
    fantacalcio_data = Column(JSON)  # Fantacalcio.it data
